...
HammerDescriptions = {
    ...
    SpearThrowElectiveCharge = "Hold Special to charge your skewer for up to +200% base damage; minimum range reduced",
    ...
    GunExplodingSecondaryTrait = "Your Special becomes a rocket that deals 80 base damage",
    ...
    GunLoadedGrenadeBoostTrait = "Your Igneus Eden Special radiates 250% damage in a larger area",
    GunLoadedGrenadeLaserTrait = "Your Igneus Eden Attack ramps up damage to a foe +100% faster",
    ...
    GunLoadedGrenadeSpeedTrait = "Your Igneus Eden Attack fires 50% faster with 15% more range",
...
ChaosBlessingDescriptions = {
    ...
    ChaosBlessingMetapointTrait = "Afterward, any Darkness and Gemstones you find are worth +50%",
...
ChaosCurseDescriptions = {
    ChaosCurseTrapDamageTrait = "Take 200% more damage from traps",
...
GodBoonDescriptions = {
    ...
    DionysusAoETrait = "Your Cast and Festive Fog cover a wider area",
    -- Duo Boons (28)
